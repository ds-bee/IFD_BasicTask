...
class_name_list = ['chi2', 'cra2', 'mis2', 'nor2', 'sur2','chi3', 'cra3', 'mis3', 'nor3', 'sur3']
...
def main():
    ...
    for j in class_name_list:
        ...
        train.extend(tra)
        test.extend(tes)
    ftr = open(label_path + '/' + 'dong_train.txt', 'a', encoding='utf-8')
    fte = open(label_path + '/' + 'dong_test.txt', 'a', encoding='utf-8')
    for line in train:
        ftr.write(line)
    ...
    filename_tra = label_path + '/' + 'dong_train.txt'
    filename_tes = label_path + '/' + 'dong_test.txt'
