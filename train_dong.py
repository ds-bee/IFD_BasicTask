...
from utils.train_utils_dong import train_utils
...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str, default='DONG', help='the name of the data')  # 数据预处理方式(raopt)
    ...
    parser.add_argument('--batch_size', type=int, default=2, help='batch size of the training process')
