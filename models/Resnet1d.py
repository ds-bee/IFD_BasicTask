...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channel=1, out_channel=10, zero_init_residual=False):
        ...
        # This improves the model_name by 0.2~0.3% according to https://arxiv.org/abs/1706.02677
...
def resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model_name.
...
def resnet34(pretrained=False, **kwargs):
    """Constructs a ResNet-34 model_name.
...
def resnet101(pretrained=False, **kwargs):
    """Constructs a ResNet-101 model_name.
...
def resnet152(pretrained=False, **kwargs):
    """Constructs a ResNet-152 model_name.
