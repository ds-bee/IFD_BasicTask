...
from utils.train_utils_cqdx import train_utils
args = None
...
def parse_args():
    ...
    parser.add_argument('--label_type', type=str, choices=['3_25.2', '0_0', '1_1.4', '2_2.8'], default='3_25.2',
                        help='Working Condition of the data')
    parser.add_argument('--model_name', type=str, default='Vit', help='the name of the model_name')
    parser.add_argument('--data_name', type=str, default='CQDX', help='the name of the data')  # 数据预处理方式(raopt)
    parser.add_argument('--data_dir', type=str, default="./label/CQDX_label",
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='batch size of the training process')
    parser.add_argument('--num_workers', type=int, default=0, help='the number of training process')
    # optimization information
    parser.add_argument('--opt', type=str, choices=['sgd', 'adam', 'custom'], default='adam', help='the optimizer')
