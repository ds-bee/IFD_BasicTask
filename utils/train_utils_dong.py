...
class train_utils(object):
    ...
    def setup(self):
        ...
        if args.model_name == 'PretrainedTorchModel':
            self.model = getattr(models, args.model_name)(num_class=10, torch_model=args.pretrained_model_name)
        elif args.model_name == "Vit":
            self.model = getattr(models, args.model_name)(image_size=256,
                                                          patch_size=32,
                                                          num_classes=10,
                                                          dim=1024,
                                                          depth=6,
            ...
            self.model = getattr(models, args.model_name)(num_class=10)
        ...
        self.loss_p = 648 / args.batch_size if 648 % args.batch_size == 0 else 648 // args.batch_size + 1
