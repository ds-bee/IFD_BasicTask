...
from datasets_process.SequenceDatasets import dataset
from datasets_process.sequence_aug import *
...
def get_files(root, test=False):
    ...
    '''
    data_root1 = os.path.join('/tmp', root, datasetname[3])  # 正常数据的路径
    data_root2 = os.path.join('/tmp', root, datasetname[0])  # 12kfan数据路径
